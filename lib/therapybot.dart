...
class TherapyChat extends StatefulWidget {
  TherapyChat({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TherapyChatState createState() => _TherapyChatState();
}

class _TherapyChatState extends State<TherapyChat> {
